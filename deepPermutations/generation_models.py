...
from keras.layers import Dense, Activation, Lambda, LSTM, TimeDistributed, Dropout, merge


def deepbach_skip_sop(num_features_lr,
                      num_features_meta, num_pitches, num_units_lstm=[200],
    ...
    predictions_center = central_metas
    ...
    predictions = Dense(num_pitches)(predictions)
    pitch_prediction = Activation('softmax', name='predictions')(predictions)

    model = Model(input=[left_features, right_features,
